...
try {
    ...
    // Prepare delete statement for specific messages
    ...
    echo "Removing single-word test messages...\n";
    ...
    ");
    $test_stmt->execute();
    $test_deleted = $test_stmt->rowCount();
    echo "  Deleted: $test_deleted single-word test messages\n";
