 ...
 * This will help verify that the API endpoint can handle decode errors
 * Upload this to the server and run at: https://data.cnymesh.org/test_send_decode_error.php
 */
