...
class StoreAndForward extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Meshtastic\StoreAndForward_RequestResponse::class);
        $this->rr = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Meshtastic\StoreAndForward_Statistics::class);
    ...
    {
        GPBUtil::checkMessage($var, \Meshtastic\StoreAndForward_History::class);
    ...
    {
        GPBUtil::checkMessage($var, \Meshtastic\StoreAndForward_Heartbeat::class);
