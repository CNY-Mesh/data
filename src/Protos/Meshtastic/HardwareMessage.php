 ...
 *
 * Generated from protobuf message <code>meshtastic.HardwareMessage</code>
 */
class HardwareMessage extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.meshtastic.HardwareMessage.Type type = 1;</code>
     */
    protected $type = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Meshtastic\RemoteHardware::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Meshtastic\HardwareMessage_Type::class);
        $this->type = $var;
