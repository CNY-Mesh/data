...
namespace Meshtastic\HardwareMessage;
 ...
 * TODO: REPLACE
 *
 * Protobuf type <code>meshtastic.HardwareMessage.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Meshtastic\HardwareMessage_Type::class);
